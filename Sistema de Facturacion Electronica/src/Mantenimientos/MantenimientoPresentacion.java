...
public class MantenimientoPresentacion extends javax.swing.JPanel {
    Clases.Llenar_Tablas con = new Llenar_Tablas();
    Clases.Conexion cn = new Clases.Conexion();

    public MantenimientoPresentacion() {
        initComponents();
        showTableData();
    ...
    try{
        String sql = "select presentacion_producto as \"Nombre\" From presentacion where id_estado = 1";
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 240, -1));
        ...
        add(txtId_cliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 34, -1));
    ...
    private void btn_AgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_AgregarMouseClicked
        ...
        if (txtNombre_usuario.getText().equals(""))
           ...
           new rojerusan.RSNotifyFade("INFORMATION","Para agregar un mantenimiento, no debe de haber campos vacios",7,RSNotifyFade.PositionNotify.BottomRight,RSNotifyFade.TypeNotify.INFORMATION).setVisible(true);
            ...
            ClasesMetodos.MetodosPresentacion obj = new ClasesMetodos.MetodosPresentacion();
    ...
    private void Tabla_clienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Tabla_clienteMouseClicked
      try{
            ...
            String sql= "select id_presentacion_producto as \"Id\", presentacion_producto as \"Nombre\" From presentacion where presentacion_producto = '"+Table_click+"' ";
            PreparedStatement ps = cn.Conectar().prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
