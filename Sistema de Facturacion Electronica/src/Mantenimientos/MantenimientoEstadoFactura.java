...
public class MantenimientoEstadoFactura extends javax.swing.JPanel {
    Clases.Llenar_Tablas con = new Llenar_Tablas();
    Clases.Conexion cn = new Clases.Conexion();

    public MantenimientoEstadoFactura() {
        initComponents();
        showTableData();
    ...
    try{
        String sql = "select estado_factura as \"Nombre\", descripcion_factura as \"Descripcion\" from estado_factura where id_estado = 1";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Estado Factura");
    ...
    private void btn_AgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_AgregarMouseClicked
        ...
        if (txtNombre_usuario.getText().equals("") || jTextArea1.getText().equals(""))
            ...
            ClasesMetodos.MetodosEstadoFactura obj = new ClasesMetodos.MetodosEstadoFactura();
    ...
    private void Tabla_clienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Tabla_clienteMouseClicked
       try{
            ...
            String sql= "select id_estado_factura as \"Id\", estado_factura as \"Nombre\", descripcion_factura as \"Descripcion\" from estado_factura where estado_factura = '"+Table_click+"' ";
            PreparedStatement ps = cn.Conectar().prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
