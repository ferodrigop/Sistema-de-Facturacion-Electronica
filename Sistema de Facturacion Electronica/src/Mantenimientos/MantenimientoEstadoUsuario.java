...
public class MantenimientoEstadoUsuario extends javax.swing.JPanel {
    Clases.Llenar_Tablas con = new Llenar_Tablas();
    Clases.Conexion cn = new Clases.Conexion();

    public MantenimientoEstadoUsuario() {
        initComponents();
        showTableData();
    ...
    try{
        String sql = "select estado as \"Nombre\" From estado ";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Estado Usuario");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));

        txtEstadoU.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtEstadoUActionPerformed(evt);
            }
        });
        txtEstadoU.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtEstadoUKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtEstadoUKeyTyped(evt);
            }
        });
        add(txtEstadoU, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 100, 170, 30));
        add(txtId_cliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 70, 34, -1));
    ...
    private void btn_AgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_AgregarMouseClicked
        ...
        if (txtEstadoU.getText().equals(""))
         ...
         new rojerusan.RSNotifyFade("INFORMATION","Para agregar un mantenimiento, no debe de haber campos vacios",7,RSNotifyFade.PositionNotify.BottomRight,RSNotifyFade.TypeNotify.INFORMATION).setVisible(true);
            ...
            ClasesMetodos.MetodosEstadoUsuario obj = new ClasesMetodos.MetodosEstadoUsuario();
            obj.setNombre(txtEstadoU.getText());
        ...
        if(txtId_cliente.getText().equals("")){
            ...
            if(eliminar == 0){
                if(obj.EliminarTipoFactura()){
                   new rojerusan.RSNotifyFade("CORRECTO","Mantenimiento eliminado correctamente",7,RSNotifyFade.PositionNotify.BottomRight,RSNotifyFade.TypeNotify.SUCCESS).setVisible(true);
                    showTableData();
                }else{
    ...
    private void btn_actualizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_actualizarMouseClicked
        if (txtEstadoU.getText().equals(""))
        {
           ...
           new rojerusan.RSNotifyFade("INFORMATION","Para moificar un mantenimiento, no debe de haber campos vacios",7,RSNotifyFade.PositionNotify.BottomRight,RSNotifyFade.TypeNotify.INFORMATION).setVisible(true);
        }
        else{
                 ClasesMetodos.MetodosEstadoUsuario obj = new ClasesMetodos.MetodosEstadoUsuario();
                obj.setNombre(txtEstadoU.getText());
      ...
      ClasesMetodos.MetodosEstadoUsuario obj = new ClasesMetodos.MetodosEstadoUsuario();
        if (txt_buscar_nombre.getText().equals("")){
            ...
            if(obj.BuscarTipoFactura(obj)){              
                txtEstadoU.setText(obj.getNombre());             
            } else {
    ...
    private void Tabla_clienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Tabla_clienteMouseClicked
      try{
            ...
            String sql= "select id_estado as \"Id\", estado as \"Nombre\" From estado = '"+Table_click+"' ";
            PreparedStatement ps = cn.Conectar().prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
            
            if(rs.next()){
            String add1 = rs.getString("id_estado");
            txtId_cliente.setText(add1);
            String add2 = rs.getString("estado");
            txtEstadoU.setText(add2);
    ...
    private void txtEstadoUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtEstadoUActionPerformed
       
    }//GEN-LAST:event_txtEstadoUActionPerformed

    private void txtEstadoUKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtEstadoUKeyPressed

    }//GEN-LAST:event_txtEstadoUKeyPressed

    private void txtEstadoUKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtEstadoUKeyTyped
    ...
    }//GEN-LAST:event_txtEstadoUKeyTyped
    ...
    private javax.swing.JTextField txtEstadoU;
